...
EsiaStrategy.prototype.userProfile = function(accessToken, done) {
	...
	let token_header = JSON.parse(base64url.decode(token_parts[0]));
	let token_data = JSON.parse(base64url.decode(token_parts[1]));
	...
	let token_signature = base64url.toBuffer(token_parts[2]);
